        ...
        try {
            ...
            for (const proxy of proxiesToShow) {
                ...
                if (countryParam1) {
                    ...
                    if (type === 'vless') {
                        if (wildcard) {
                            urlString = `vless://${uuid}@${wildcard}:443?encryption=none&type=ws&host=${wildcard}.tp1.bmkg.xyz&path=%2F${ip}-${port}&security=tls&sni=${wildcard}.tp1.bmkg.xyz#(${wildcard})${country}+${provider}`;
                        } else {
                        ...
                        if (wildcard) {
                            urlString = `trojan://${uuid}@${wildcard}:443?encryption=none&type=ws&host=${wildcard}.tp1.bmkg.xyz&path=%2F${ip}-${port}&security=tls&sni=${wildcard}.tp1.bmkg.xyz#(${wildcard})${country}+${provider}`;
                        } else {
                        ...
                        if (wildcard) {
                            urlString = `ss://bm9uZTo1ZDJlYmQyYS05Y2I5LTRkMWItYWY1NS04NjE3ZDNlODFmMzk%3D@${wildcard}:443?encryption=none&type=ws&host=${wildcard}.tp1.bmkg.xyz&path=%2F${ip}-${port}&security=tls&sni=${wildcard}.tp1.bmkg.xyz#(${wildcard})${country}+${provider}`;
                        } else {
